...
export const RIOT_GAMES_CURRENT_SUMMONER_RANKS = `https://na1.api.riotgames.com/lol/league/v4/entries/by-summoner/${RIOT_GAMES_ENCRYPTED_SUMMONER_ID}?api_key=${process.env.REACT_APP_RIOT_GAMES_API_KEY}`;
